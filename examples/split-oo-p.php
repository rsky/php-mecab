...
/**
 * php-mecab/examples
 * split string into an array of part-of-speech (OO-API, persistent)
 * charset=utf-8
 */
...
print_r(MeCab::split($str, null, null, 'mecab_ipadic_is_noun', true));
print_r(MeCab::split($str, null, null, array('MeCab_IPADic', 'isNoun'), true));
